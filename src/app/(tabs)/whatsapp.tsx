...
import { alertas, conversa, talhoes, usuario } from "@/data/mockData"
import { useSession } from "@/context/SessionContext"

type MsgTexto = { id: number; tipo: "recv" | "send"; texto: string; hora: string }
type MsgArquivo = { id: number; tipo: "arquivo"; nome: string; subtexto: string; hora: string }
type Mensagem = MsgTexto | MsgArquivo

const SUGESTOES = [
  "Como está o Talhão Central?",
  "Janela ideal para soja?",
  "Gerar laudo de risco hídrico",
]
...
function gerarResposta(texto: string, primeiroNome: string): string {
